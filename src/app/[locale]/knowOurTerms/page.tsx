    ...
    <div className="container-knowOurTerms">
      <div className="header">
        ...
        <div className="header-title">
          ...
          <p>
            {t("By using any of our products and services, you agree to the")} <span>{t("Terms of Use")}</span> {t("and")}{" "}
            <span>{t("Privacy Policy")}.</span> {t("You hereby agree, represent and undertake to")}:
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col justify-evenly h-[calc(100vh-250px)]">
        ...
        <div className="container-btns">
          <Link href={"/login"} className="container-btnClose">
            <ButtonSecondary text={t("Close")} />
          </Link>
          {/* <Link href={`/membership?refferalWallet=${refferalCode}`} className="container-btnAgree"> */}

          <Link href={`/register?refferal=${refferalCode}`} className="container-btnAgree">
